...
describe("user api routes", () => {
  ...
  it("gets current user profile", async () => {
    const { GET } = await import("@wse/plugin-shop/app/api/user/profile/route");
    const res = await GET(createJsonRequest("http://localhost/api/user/profile", "GET"));
    expect(res.status).toBe(200);
  });

  it("updates user profile", async () => {
    const { PUT } = await import("@wse/plugin-shop/app/api/user/profile/route");
    const res = await PUT(
  ...
  it("deletes user profile when no ongoing order", async () => {
    const { DELETE } = await import("@wse/plugin-shop/app/api/user/profile/route");
  ...
  it("returns user orders list", async () => {
    ...
    const { GET } = await import("@wse/plugin-shop/app/api/user/orders/route");
  ...
  it("returns one order detail", async () => {
    const { GET } = await import("@wse/plugin-shop/app/api/user/orders/[id]/route");
    const res = await GET(
  ...
  it("submits product review and shop feedback", async () => {
    const { POST: postReview } = await import("@wse/plugin-shop/app/api/user/reviews/route");
    const { POST: postFeedback } = await import("@wse/plugin-shop/app/api/user/feedback/route");
  ...
  it("returns unauthorized for user routes", async () => {
    ...
    const { GET: getProfile } = await import("@wse/plugin-shop/app/api/user/profile/route");
    const { GET: getOrders } = await import("@wse/plugin-shop/app/api/user/orders/route");
