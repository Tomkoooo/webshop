...
import { useIsMobile } from '@wse/core/hooks/use-mobile';
...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@wse/core/components/ui/tooltip';
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn(
        'border-sidebar-border mx-3.5 flex min-w-0 flex-col gap-1 pl-3 py-0.5',
        'group-data-[collapsible=icon]:hidden',
        className
      )}
      {...props}
