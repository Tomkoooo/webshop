...
import { UserNav } from "@wse/core/components/layout/UserNav"
...
const ALL_NAV_LINKS = [
  { name: "Főoldal", href: "/" },
  { name: "Szerkesztői", href: "/editorial" },
  { name: "Napló", href: "/journal" },
...
export function Navbar({
  ...
  if (cmsChromePreview) {
    return (
      <header
        className="relative z-10 w-full shrink-0 border-b border-border bg-background/95 py-5 shadow-sm"
