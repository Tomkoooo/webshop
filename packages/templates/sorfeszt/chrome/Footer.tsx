...
const DEFAULT_QUICK_LINKS: ReadonlyArray<{ label: string; href: string }> = [
...
function resolveQuickLinks(settings: FooterSettings | undefined) {
  ...
  if (!links.length || looksLikeShopDefaults) {
    return DEFAULT_QUICK_LINKS.map((item) => ({ ...item }))
  }
...
export function Footer({
  ...
  const strings = FOOTER_STRINGS.hu
