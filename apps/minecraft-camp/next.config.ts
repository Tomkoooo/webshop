...
const nextConfig: NextConfig = {
  env: {
    WSE_SITE_CONFIG_JSON: "{\"id\":\"minecraft-camp\",\"label\":\"minecraft-camp\",\"templateId\":\"minecraft-camp\",\"plugins\":[\"camp-booking\"],\"pluginConfig\":{\"camp-booking\":{\"storefrontMode\":\"campOnly\",\"currency\":\"HUF\"}}}",
  },
  /* config options here */
  output: "standalone",
  reactCompiler: true,
