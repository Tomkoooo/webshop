...
const nextConfig: NextConfig = {
  env: {
    WSE_SITE_CONFIG_JSON: "{\"id\":\"keramia-dental\",\"label\":\"keramia-fogfeherites\",\"templateId\":\"keramia-fogfeherites\",\"allowedTemplates\":[\"keramia-fogfeherites\",\"keramia-implant\"],\"plugins\":[]}",
    TEMPLATE_PIN: "keramia-fogfeherites",
  },
  /* config options here */
  output: "standalone",
  reactCompiler: true,
